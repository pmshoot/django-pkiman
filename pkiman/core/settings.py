...
PKIMAN_MAX_OLD_PKI_TIME = env('PKIMAN_MAX_OLD_PKI_TIME', cast=int, default=24)
PKIMAN_DAYS_BEFORE_EXPIRED_NOTIFY = env('PKIMAN_DAYS_BEFORE_EXPIRED_NOTIFY', cast=int, default=5)
